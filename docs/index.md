...
hero:
  name: "HAM Akademie"
  text: "Výukový portál pro budoucí radioamatéry"
  image:
    dark: ./logo1.png
    light: ./logo2.jpeg
  actions:
...
features:
  - title: Chceš se dozvědět o čem je amatérské rádio?
    details: Tak to jsi zavítal na správné místo! Na našem portálu se dozvíš základní informace a co vše je s amatérským rádiem možné dělat.
    icon: 📡
