...
**Kvalita rádiového spojení závisí na mnoha faktorech**: použitém vysílacím výkonu, anténě, vzdálenosti mezi stanicemi a také na aktuálních podmínkách [šíření rádiových vln](/priprava-ke-zkouskam/sireni-radiovych-vln/). Pro navázání a udržení radioamatérského spojení **je proto důležitým údajem zpráva o slyšitelnosti signálu**. Pro posouzení kvality příjmu se po navázání spojení udává tzv. **report**. V radioamatérské praxi se k tomuto účelu používá **systém RST**.
