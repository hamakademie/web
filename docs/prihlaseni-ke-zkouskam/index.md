...
![Budova Českého telekomunikačního úřadu](ctu.png)

Až si budeš myslet, že jsi připraven na složení zkoušky, **je na čase podat si přihlášku** ke zkoušce na Český telekomunikační úřad (ČTÚ). Na [ePortálu ČTÚ](https://eportal.ctu.gov.cz/) jsou k dispozici on-line formuláře, které vyplníš, pošleš a zaplatíš příslušné poplatky.
...
Pro získání každé z výše zmíněných listin je potřeba vyplnit příslušný formulář, **celkem tedy budeš vyplňovat dva formuláře**.

## Jaký je postup pro vyplnění formulářů?
::: info Formálně správný způsob
